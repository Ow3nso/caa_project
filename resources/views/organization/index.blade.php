    ...
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
        ...
        <div class="flex items-center space-x-3 w-full sm:w-auto">
            <div class="flex bg-gray-100 p-1 rounded-lg">
                ...
                <button class="px-4 py-1.5 text-sm font-medium rounded-md text-gray-500 hover:text-caa-dark-navy">Approved</button>
                <button class="px-4 py-1.5 text-sm font-medium rounded-md text-gray-500 hover:text-caa-dark-navy">Pending</button>
            </div>
            
            <a href="{{ route('apply.organization') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-caa-medium-blue hover:bg-caa-dark-blue focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-caa-medium-blue transition">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50 text-gray-600 text-sm border-b border-gray-200">
                        <th class="py-4 px-6 font-semibold">Reg ID</th>
                ...
                <tbody class="text-sm divide-y divide-gray-100">
                    <tr class="hover:bg-gray-50 transition">
                        <td class="py-4 px-6 font-medium text-caa-dark-navy">ORG-101</td>
                        <td class="py-4 px-6 text-gray-700">Skyways Aviation Institute</td>
                        <td class="py-4 px-6 text-gray-600">Training</td>
                        <td class="py-4 px-6">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                Approved
                            </span>
                        </td>
                        <td class="py-4 px-6 text-gray-500">10 Jan 2022</td>

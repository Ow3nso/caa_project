                ...
                <tbody class="text-sm divide-y divide-gray-100">
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-4 px-6">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-50 text-blue-700 border border-blue-200 mr-1">C5</span>
                        </td>
                        <td class="py-4 px-6">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-4 px-6">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-50 text-blue-700 border border-blue-200 mr-1">C3</span>
                        </td>
                        <td class="py-4 px-6">

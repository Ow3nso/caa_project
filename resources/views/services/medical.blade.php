...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Medical Certifications - CAA Services</title>
        ...
        <main class="flex-grow">
            <div class="bg-caa-dark-blue py-20 px-6">
                <div class="max-w-4xl mx-auto text-center text-white">
                    <h1 class="text-4xl md:text-5xl font-extrabold mb-6">Medical Certifications</h1>
                    <p class="text-lg md:text-xl text-caa-light-blue leading-relaxed">
                        Aviation medical certification to ensure personnel are medically fit to exercise the privileges of their licenses.
                    </p>
                </div>
            </div>

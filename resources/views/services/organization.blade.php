...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Organization Approvals - CAA Services</title>
        ...
        <main class="flex-grow">
            <div class="bg-caa-dark-blue py-20 px-6">
                <div class="max-w-4xl mx-auto text-center text-white">
                    <h1 class="text-4xl md:text-5xl font-extrabold mb-6">Organization Approvals</h1>
                    <p class="text-lg md:text-xl text-caa-light-blue leading-relaxed">
                        Aviation training institutes and service providers must be certified to ensure the highest educational and operational standards.
                    </p>
                </div>
            </div>
            ...
            <div class="max-w-4xl mx-auto py-16 px-6">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
                    ...
                    <div class="space-y-6 text-gray-600 leading-relaxed">
                        <p>
                            Apply for an Approved Training Organization (ATO) certificate or other service provider approvals.
                        </p>
                    </div>

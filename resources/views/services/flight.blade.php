...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Flight Operations & Personnel - CAA Services</title>
        ...
        <main class="flex-grow">
            <div class="bg-caa-dark-blue py-20 px-6">
                <div class="max-w-4xl mx-auto text-center text-white">
                    <h1 class="text-4xl md:text-5xl font-extrabold mb-6">Flight Operations & Personnel</h1>
                    <p class="text-lg md:text-xl text-caa-light-blue leading-relaxed">
                        Obtain your personnel licenses and flight operation certificates. We manage licensing for pilots, air traffic controllers, and dispatchers.
                    </p>
                </div>
            </div>

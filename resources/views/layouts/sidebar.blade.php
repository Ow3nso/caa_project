<aside class="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-caa-dark-navy border-r rtl:border-r-0 rtl:border-l border-caa-dark-blue">
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="space-y-2">
            ...
            <a href="{{ route('organization.dashboard') }}" class="flex items-center px-4 py-2 text-caa-light-blue rounded-lg hover:bg-caa-dark-blue hover:text-white transition-colors {{ request()->is('admin/organization*') ? 'bg-caa-dark-blue text-white' : '' }}">
